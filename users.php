...
<head>
    ...
    <title>Utilisateurs | BookShare</title>
</head>
<body>
    ...
    <div id="container" class="clear">
        ...
        <div class="filters">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <label>Prénom: <input type="text" name="name" value="<?php echo $name ?>"></label>
                    <label> Nom: <input type="text" name="last_name" value="<?php echo $last_name ?>"></label>
                    ...
                    <label>Pays: <input type="text" name="country" value="<?php echo $country ?>"></label>
                    <label>Ville: <input type="text" name="city" value="<?php echo $city ?>"></label>
                    <input type="submit" name="submit" value="Filtrer">
            </form>
        </div>

        <div class="linetop"></div>
        <h2 class="headline">Il y a <?php echo $total ?> utilisateurs</h2>
        <div class="line"></div>
        ...
        <?php while ($row = $stmt->fetchObject()) { ?>
            ...
            <div class="one_third1">
                ...
                <div class="fl_left1">
                    ...
                    <?php } ?>
                    <p><strong>Sexe:</strong> <?php echo $row->gender ?></p>
                    <p><strong>Emplacement:</strong> <?php echo $row->country . ", " . $row->city ?></p>
                    <p><strong>Livres sur le site:</strong><a href="my_books.php?user=<?php echo $row->login ?>"
                            > <?php echo $row->count ?></a></p>
                    <a href="user.php?user=<?php echo $row->login ?>">Voir le profil complet avec les contacts</a>
                </div>
            </div>
